...
void setup(){//Display geomerty,display orianation:Lanscape, portait or sqaure
fullScreen();
//Population
titleX = width*1/5;
titleY = height*1/10;
...
//
void draw(){fill(blue);//ink, hexidecmial copied from the color selector
